...
const seedUsers = [
  ["seed_alex_chen", "Omkar Singh", "alex.chen@example.com", "https://i.pravatar.cc/150?img=1"],
  ["seed_sam_taylor", "Swaraj Unde", "sam.taylor@example.com", "https://i.pravatar.cc/150?img=2"],
  ["seed_jordan_lee", "Subhayu Das", "jordan.lee@example.com", "https://i.pravatar.cc/150?img=3"],
  ["seed_maya_patel", "Ankit Sahoo", "maya.patel@example.com", "https://i.pravatar.cc/150?img=4"],
  [
    "seed_casey_morgan",
    "Casey Morgan",
